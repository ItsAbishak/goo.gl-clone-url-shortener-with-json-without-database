...
<![endif]-->
<link href="http://www.kliptu.com/demo/goo_gl/assets/css/jquery-ui-1.10.3.css" rel="stylesheet">
        ...
        <nav class="navbar navbar-default">        
           ...
           <!-- <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="http://www.kliptu.com/demo/goo_gl/login">LOGIN</a></li>
                    <li><a href="http://www.kliptu.com/demo/goo_gl/register">SIGN UP</a></li>
                </ul>
            </div>    -->                                        
        </nav>
    </div>
...
<footer>
	<div class="container">
    	<div class="row">
        	<div class="col-md-12">
            	<ul class="nav_hor">
                    <li><a href="http://www.kliptu.com/demo/goo_gl/page/help">HELP</a></li>
                    <li><a href="http://www.kliptu.com/demo/goo_gl/page/reportspam">REPORT SPAM</a></li>
                    <li><a href="http://www.kliptu.com/demo/goo_gl/page/privacy">PRIVACY POLICY</a></li>
                    <li><a href="http://www.kliptu.com/demo/goo_gl/page/usagepolicy">ACCEPTABLE USAGE POLICY</a></li>
                    <li><a href="http://www.kliptu.com/demo/goo_gl/page/terms">TERMS OF SERVICE</a></li>
                </ul>
            </div>
        </div>
...
<script src="http://www.kliptu.com/demo/goo_gl/assets/jquery/1.11.3/jquery.min.js"></script>
<!-- Include all compiled plugins (below), or include individual files as needed -->
<script src="http://www.kliptu.com/demo/goo_gl/assets/js/jquery-ui-1.10.3.min.js"></script>
<script src="http://www.kliptu.com/demo/goo_gl/assets/bootstrap-3.3.6/js/bootstrap.min.js"></script>
